...
const notification = new JSGameTools.NotificationMessage(null, null, null, true, null, null, new JSGameTools.Label("A notification", null, null, null, null, "white", JSGameTools.Constants.Alignement.CENTER), new JSGameTools.Button("A button, aligned to the left"));
